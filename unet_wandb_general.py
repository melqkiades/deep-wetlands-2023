# -*- coding: utf-8 -*-
"""Unet_wandb_GENERAL.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1W0HXFuMEph_-j9dfxMe0hBRqAFXYQmKR
"""
...
def validation_loss(loader, model, loss_fn, epoch):
...
def save_predictions_as_imgs(
    ...
    for idx, (x, y) in enumerate(loader):
        ...
        #out = torchvision.utils.flow_to_image(preds)
        #input = torchvision.utils.flow_to_image(y.unsqueeze(1))
       
        out_path = os.path.join(folder,"pred_"+str(idx)+".png")
        out_img = Image.open(out_path)
        image_out = wandb.Image(out_img, caption="Prediction")

        in_path = os.path.join(folder,str(idx)+".png")
        input = Image.open(in_path)
        image_in = wandb.Image(input, caption="Ground_Truth")
        
        wandb.log({"Ground Truth": image_in, "Predicted_Mask": image_out })
...
def main():
  ...
  for epoch in range(NUM_EPOCHS):
    ...
    #validation_loss(val_loader, model, loss_fn, epoch)
