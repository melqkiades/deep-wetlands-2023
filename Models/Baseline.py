...
FILENAME = 'Baseline_VH_on_UNet'
HYPE_NAME = 'Baseline sweep'
TAGS = ['Baseline', 'Only VH', 'New dataset']
...
if __name__ == '__main__':
    model = UNet(encoder_channels=(1, 64, 128, 256, 512, 1024), decoder_channels=(1024, 512, 256, 128, 64)).to(DEVICE)
    if not HYPE_TUNE:
        main(model)
    else:
