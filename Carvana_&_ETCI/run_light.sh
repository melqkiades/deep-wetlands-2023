...
singularity exec $CONTAINER stdbuf -oL nohup python3 -u /cephyr/users/ezioc/Alvis/deep-wetlands-2023/unet_wandb_light.py >> ~/light_ETCI_LR_warm_Anneal_1_epoch.log 2>&1
