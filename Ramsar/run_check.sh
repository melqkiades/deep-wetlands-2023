...
singularity exec $CONTAINER stdbuf -oL nohup python3 -u /cephyr/users/ezioc/Alvis/deep-wetlands-2023/ramsar/check_tif_clean.py >> /cephyr/users/ezioc/Alvis/deep-wetlands-2023/ramsar/check.log 2>&1
