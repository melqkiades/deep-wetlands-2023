...
singularity exec $CONTAINER stdbuf -oL nohup python3 -u /cephyr/users/ezioc/Alvis/deep-wetlands-2023/ramsar/test_IO_model.py >> /cephyr/users/ezioc/Alvis/deep-wetlands-2023/ramsar/test_IO_model.log 2>&1
