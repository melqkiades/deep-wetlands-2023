...
reg ="Warm"#"Cos_Anneal" #"Linear"#"Warm"#"Cos_Anneal"
        ...
        for (images, labels) in validation_data_loader:
            ...
            if plot_images:
                ...
                for i in range(10):
                    ...
                    axs[1, i].imshow(true_seg, cmap=cmap, vmin=0., vmax=1., interpolation='none')
                    axs[1, i].axis('off')
                    #                   axs[1, i].set_title('True segmentation map')
                    axs[2, i].imshow(model_seg, cmap=cmap, vmin=0., vmax=1., interpolation='none')
                    axs[2, i].axis('off')
